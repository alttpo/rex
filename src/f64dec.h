...
enum f64dec_error {
    ...
    F64DEC_ERR_READ_TOO_MUCH = -6,
    F64DEC_ERR_READ_FAILURE = -7,
    F64DEC_ERR_CONSUMER_DATA_FAILURE = -8,
    F64DEC_ERR_CONSUMER_FINAL_FAILURE = -9,
    F64DEC_ERR_CONSUMER_DELIMITER_FAILURE = -10
};
